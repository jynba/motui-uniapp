...
<template>
  <view :class="classes" :style="props.customStyle">
    <view class="mot-ecard__title">
      {{ props.chooseText || translate('chooseText') }}
    </view>

    <view class="mot-ecard__list">
      <view
        v-for="(item, index) in props.list"
        :key="index"
        class="mot-ecard__list__item"
      ...
      <view
        ...
        class="mot-ecard__list__input"
        :class="{ active: currentIndex === -1 }"
        @click="handleInputClick"
      >
        <view>{{ props.otherValueText || translate('otherValueText') }}</view>

        <view class="mot-ecard__list__input--con">
          <input
            class="mot-ecard-input"
      ...
      <view v-if="props.showStep" class="mot-ecard__list__step">
