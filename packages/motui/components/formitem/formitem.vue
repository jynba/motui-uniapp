...
import MotCell from '../cell/cell.vue'
...
const labelPositionClass = computed(() => {
  ...
  return `mot-form-item__${position}`
})
...
const starPositionClass = computed(() => {
  ...
  return `mot-form-item__star-${position}`
})
...
<template>
  ...
  >
    <view
      ...
      class="mot-cell__title mot-form-item__label"
      :style="labelStyle"
    ...
    <view class="mot-cell__value mot-form-item__body">
      <view class="mot-form-item__body__slots" :style="bodyStyle">
        <slot />
      </view>
      <view v-if="formErrorTip[prop] && showErrorMessage" class="mot-form-item__body__tips" :style="errorMessageStyle">
        {{ formErrorTip[prop] }}
      </view>
    </view>
  </MotCell>
