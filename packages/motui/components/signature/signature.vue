...
<template>
  <div :class="classes" :style="customStyle">
    <div class="mot-signature-inner spcanvas_WEAPP">
      <canvas
    ...
    <MotButton custom-class="mot-signature-btn" type="default" @click="clear()">
      {{ translate('reSign') }}
    </MotButton>
    <MotButton custom-class="mot-signature-btn" type="primary" @click="confirm()">
      {{ translate('confirm') }}
    </MotButton>
  </div>
</template>
