...
const classes = computed(() => {
  return getMainClass(props, componentName, {
    [`mot-toast-${toastOptions.value.size}`]: true,
    'mot-toast-cover': toastOptions.value.cover,
    'mot-toast-center': toastOptions.value.center,
    'mot-toast-loading': toastOptions.value.type === 'loading',
    'mot-toast-loading-rotate': toastOptions.value.loadingRotate,
    'mot-toast-has-icon': hasIcon.value,
  })
})
...
<template>
  ...
  >
    ...
    >
      ...
      <template v-else>
        <view
          class="mot-toast-inner"
          :style="innerStyles"
        >
          <view v-if="hasIcon" class="mot-toast-icon-wrapper">
            <MotIcon :name="iconName" :size="toastOptions.iconSize" custom-color="#ffffff" />
          </view>

          <text v-if="toastOptions.title" class="mot-toast-title">
            {{ toastOptions.title }}
          </text>

          <rich-text v-if="toastOptions.msg" class="mot-toast-text" :nodes="toastOptions.msg" />
        </view>
      </template>
    </view>
  </MotTransition>
