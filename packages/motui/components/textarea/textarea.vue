...
<template>
  <view :class="classes" :style="props.customStyle">
    <textarea
      v-if="props.readonly"
      class="mot-textarea__textarea mot-textarea__textarea__readonly"
    ...
    />
    <view v-if="props.limitShow && innerMaxLength > 0" class="mot-textarea__limit">
