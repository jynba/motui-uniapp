...
// #ifdef H5
import MotPickerColumn from '../pickercolumn/pickercolumn.vue'
...
<template>
  <view :class="classes" :style="props.customStyle">
    <view v-if="props.showToolbar" class="mot-picker__bar">
      <view class="mot-picker__cancel mot-picker__left mot-picker__button" @click="cancel">
        {{ props.cancelText || translate('cancel') }}
      </view>
      <view class="mot-picker__title">
        {{ props.title }}
      </view>
      <view class="mot-picker__confirm mot-picker__right mot-picker__button" @click="onConfirm ">
    ...
    >
      <picker-view-column v-for="(column, columnIndex) in (columnsList as PickerOption[])" :key="columnIndex">
        <view
          ...
          class="mot-picker-roller-item-tarotile"
    ...
    <!-- #ifdef H5 -->
    <view class="mot-picker__column" :style="columnStyle">
      <view
        v-for="(column, columnIndex) in (columnsList as PickerOption[][])"
        :key="columnIndex"
        class="mot-picker__columnitem"
      >
        <MotPickerColumn
          :ref="columnRef"
          :column="column"
