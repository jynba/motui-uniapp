...
<template>
  <view :class="classes" :style="styles">
    <view
      class="mot-menu-item-placeholder-element"
      :class="{ 'mot-hidden': !state.showPopup, 'placeholder-element-up': parent?.props.direction === 'up' }"
    ...
    >
      <scroll-view :scroll-y="true">
        <view id="mot-menu-item__content" class="mot-menu-item__content">
          <view
            v-for="(option, index) in options"
            :key="index"
            class="mot-menu-item__option"
