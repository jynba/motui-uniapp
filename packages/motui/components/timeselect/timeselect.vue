...
<template>
  ...
  >
    <view :class="classes" :style="customStyle">
      <view class="mot-time-select__title">
        <view class="mot-time-select__title__fixed">
          <span v-if="!$slots.title">{{ title || translate('pickupTime') }}</span>
          <slot v-else name="title" />
        </view>
      </view>
      <view class="mot-time-select__content">
        <view class="mot-time-select__content__pannel">
          <slot name="pannel" />
        </view>
        <view class="mot-time-select__content__detail">
          <slot name="detail" />
        </view>
      </view>
    </view>
