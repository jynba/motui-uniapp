...
<template>
  <view :class="classes" :style="props.customStyle">
    ...
    >
      <view :id="leftRefId" class="mot-swipe__left" @click="handleClick('left')">
        <slot name="left" />
      </view>

      <view class="mot-swipe__content" @click="handleClick('content')">
        <slot name="default" />
      </view>

      <view :id="rightRefId" class="mot-swipe__right" @click="handleClick('right')">
        <slot name="right" />
      </view>
    </view>
  </view>
