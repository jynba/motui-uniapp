...
<template>
  ...
  >
    ...
    >
      ...
      >
        ...
        <view
          ...
          class="mot-picker-roller-item"
          :class="{
            'mot-picker-roller-item-hidden': isHidden(index + 1),
        ...
        <view
          v-if="item && item[props.fieldNames.text] && !props.threeDimensional"
          class="mot-picker-roller-item-tile"
    ...
    <view class="mot-picker-roller-mask" :style="maskStyles" />
  </view>
</template>
