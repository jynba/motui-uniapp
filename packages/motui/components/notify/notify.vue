...
const classes = computed(() => {
  return getMainClass(props, componentName, {
    ...
    [`mot-notify--${notifyStatus.value.type || props.type}`]: true,
  })
})
</script>
...
<template>
  <MotPopUp v-model:visible="isShowPopup" :custom-style="notifyStatus.safeAreaInsetTop ? `top:${safeHeight}px` : ''" safe-area-inset-bottom safe-area-inset-top :z-index="99999999" :position="notifyStatus.position" :overlay="false">
    <div
      :class="classes"
      :style="styles"
      @click="clickCover"
