...
<template>
  <view :class="classes" :style="styles" @click="handleClick">
    <slot>
      <view v-if="$slots.icon" class="mot-cell__icon">
        <slot name="icon" />
      </view>

      <view v-if="props.title || props.subTitle || $slots.title" class="mot-cell__title">
        <template v-if="props.subTitle">
          ...
          <view class="mot-cell__title-desc">
            {{ props.subTitle }}
          </view>
        </template>
      ...
      <view
        ...
        class="mot-cell__value"
        :class="{ 'mot-cell__value--alone': !props.title && !props.subTitle && !$slots.title }"
      ...
      <slot name="link">
        <Icon v-if="props.isLink || props.to" custom-class="mot-cell__link" name="right" />
      </slot>
    </slot>
  </view>
</template>
