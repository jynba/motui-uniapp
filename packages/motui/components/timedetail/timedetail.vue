...
function getClass(item: string) {
  ...
  if (find) {
    return {
      'mot-time-detail__detail__list__item': true,
      'mot-time-detail__detail__list__item--curr': find.list.filter((value: string) => value === item).length > 0,
    }
  }
}
...
<template>
  <view :class="classes" :style="customStyle">
    <view class="mot-time-detail__detail mot-time-detail__detail--moring">
      <!-- <view class="mot-time-detail__detail__time">上午</view> -->
      <view class="mot-time-detail__detail__list">
