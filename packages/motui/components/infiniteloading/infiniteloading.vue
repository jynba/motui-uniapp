...
<template>
  <scroll-view
    ...
    @touchend="touchEnd"
  >
    <view class="mot-infinite-top" :style="getStyle">
      <view id="refreshTop" class="top-box">
        <MotIcon custom-class="top-img" :name="pullIcon" />
        <view class="top-text">
    ...
    <view class="mot-infinite-container">
      <slot />
    </view>

    <view class="mot-infinite-bottom">
      <template v-if="state.isInfiniting">
        <view class="bottom-box">
          <MotIcon custom-class="bottom-img" :name="loadIcon" />
