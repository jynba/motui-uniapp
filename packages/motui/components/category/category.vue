...
<template>
  <div :class="classes" :style="customStyle">
    <div class="mot-category__cateList">
      <div v-if="type === 'classify' || type === 'text'">
        <div v-for="(item, index) in category" :key="index" class="mot-category__cateListLeft">
          <div
            :class="[checkIndex === index ? 'mot-category__cateListItemChecked' : 'mot-category__cateListItem']"
