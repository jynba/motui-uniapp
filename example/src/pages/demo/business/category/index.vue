...
<template>
  <div class="demo full category-demo">
    ...
    <mot-category :category="category" @change="change">
      <mot-category-pane :category-child="categoryChild1" @on-change="onChange" />
    </mot-category>
    ...
    <mot-category :category="category" @change="changeText">
      <mot-category-pane type="text" :category-child="categoryChild2" @on-change="onChange" />
    </mot-category>
    ...
    <mot-category>
      <mot-category-pane type="custom" :custom-category="customCategory" @on-change="changeCustom" />
    </mot-category>
  </div>
</template>
