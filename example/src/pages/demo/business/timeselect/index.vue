...
<template>
  <div class="demo h-100vh!">
    ...
    >
      <template #pannel>
        <mot-time-pannel name="2月23日(今天)" pannel-key="0" @change="handleChange1" />
        <mot-time-pannel name="2月24日(星期三)" pannel-key="1" @change="handleChange1" />
      </template>
      <template #detail>
        <mot-time-detail :times="times1" @select="selectTime1" />
      </template>
    </mot-time-select>
    <h2 class="title">
      可选择多个日期时间
    ...
    >
      <template #pannel>
        <mot-time-pannel name="2月23日(今天)" pannel-key="0" @change="handleChange2" />
        <mot-time-pannel name="2月24日(星期三)" pannel-key="1" @change="handleChange2" />
      </template>
      <template #detail>
        <mot-time-detail :times="times2" @select="selectTime2" />
      </template>
    </mot-time-select>
    <h2 class="title">
      更改标题
    ...
    <mot-toast v-model:visible="show" :msg="msg" :type="type as any" :cover="cover" />
  </div>
</template>
