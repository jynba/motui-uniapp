...
<template>
  <div class="demo h-100vh!">
    ...
    <mot-cell title="基础用法" desc="" @click="base = true" />

    <h2 class="title">
      不可售
    </h2>
    <mot-cell title="不可售" desc="" @click="notSell = true" />

    <h2 class="title">
      自定义计步器
    </h2>
    <mot-cell title="自定义计步器" desc="" @click="customStepper = true" />

    <h2 class="title">
      自定义插槽
    </h2>
    <mot-cell title="通过插槽自定义设置" desc="" @click="customBySlot = true" />

    <h2 class="title">
      规格改变后重置商品数量
    </h2>
    <mot-cell title="重置商品数量" desc="" @click="resetVisible = true" />
    ...
    >
      <template #skuHeader>
        <mot-sku-header :goods="goodsInfo" />
      </template>
    </mot-sku>
    ...
    >
      ...
      <template #skuOperate>
        <div class="sku-operate-box">
          <mot-button custom-class="sku-operate-box-dis" type="warning">
            查看相似商品
          </mot-button>
          <mot-button custom-class="sku-operate-box-dis" type="info">
            到货通知
          </mot-button>
        </div>
      </template>
    ...
    >
      <template #skuHeader>
        <mot-sku-header :goods="goodsInfo">
          <template #skuHeaderPrice>
            <div>
              <mot-price :price="goodsInfo.price" :need-symbol="true" :thousands="false" />
              <span class="tag" />
            </div>
          </template>
      ...
      <template #skuOperate>
        <div class="sku-operate-box">
          <mot-button custom-class="sku-operate-item" shape="square" type="warning">
            加入购物车
          </mot-button>
          <mot-button custom-class="sku-operate-item" shape="square" type="primary">
            立即购买
          </mot-button>
        </div>
      </template>
