...
import type { EcardChangeEvent, EcardDataItem, EcardDataValue, EcardInst } from 'motui-uniapp'
...
<template>
  <div class="demo h-100vh!">
    ...
    <mot-cell-group>
      <mot-cell title="更新选中项" is-link @click="updateCurrentIndex" />
      <mot-cell title="更新输入值" is-link @click="updateInputValue" />
      <mot-cell title="更新数量" is-link @click="updateCount" />
    </mot-cell-group>
  </div>
</template>
