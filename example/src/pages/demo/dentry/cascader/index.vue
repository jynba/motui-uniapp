...
export default {
  ...
  setup() {
    ...
    const events = {
      change(...args: any) {
        console.warn('change', ...args)
      },
      pathChange(...args: any) {
        console.warn('pathChange', ...args)
      },
    }
...
<template>
  <div class="demo h-100vh!">
    ...
    <mot-cell title="选择地址" :desc="demo1.value.toString() || '请选择地址'" @click="demo1.visible = true" />
    <mot-cascader
    ...
    <mot-cell title="选择地址" :desc="demo2.value.toString() || '请选择地址'" @click="demo2.visible = true" />
    <mot-cascader
    ...
    <mot-cell title="选择地址" :desc="demo3.value.toString() || '请选择地址'" @click="demo3.visible = true" />
    <mot-cascader
    ...
    <mot-cell title="选择地址" :desc="demo4.value.toString() || '请选择地址'" @click="demo4.visible = true" />
    <mot-cascader
    ...
    <mot-cell title="选择地址" :desc="demo5.value.toString() || '请选择地址'" @click="demo5.visible = true" />
    <mot-cascader
