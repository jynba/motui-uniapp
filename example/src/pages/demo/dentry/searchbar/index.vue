...
<template>
  <div class="demo full">
    ...
    <mot-searchbar shape="square" />

    <h2 class="title">
      搜索事件监听
    </h2>
    <mot-searchbar v-model="searchValue1" @search="onSearch" />

    <h2 class="title">
      显示搜索 icon
    </h2>
    <mot-searchbar v-model="searchValue2">
      <template #leftin>
    ...
    <mot-searchbar v-model="searchValue3" confirm-type="search">
      <template #rightout>
        搜索
      </template>
    </mot-searchbar>
    ...
    <mot-searchbar v-model="searchValue6">
      <template #clear-icon>
        <image
    ...
    <mot-searchbar v-model="searchValue5">
      <template #leftout>
        <mot-icon name="left" />
      </template>
      <template #leftin>
