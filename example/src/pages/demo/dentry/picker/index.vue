...
import type { PickerBaseEvent, PickerChangeEvent, PickerOption } from 'motui-uniapp'
...
<template>
  <div class="demo">
    ...
    <mot-cell title="城市选择" :desc="popupDesc" @click="show = true" />
    ...
    <mot-picker v-model="selectedValue1" :columns="columns" title="城市选择" @confirm="onConfirm" />

    <h2 class="title">
      多列样式
    </h2>
    <mot-picker v-model="selectedValue2" :columns="multipleColumns" title="城市选择" @confirm="onConfirm" />

    <h2 class="title">
      多级联动
    </h2>
    <mot-picker v-model="selectedCascader" :columns="cascaderColumns" title="城市选择" @confirm="onConfirm" />

    <h2 class="title">
      异步获取
    </h2>
    <mot-picker v-model="asyncValue" :columns="asyncColumns" title="城市选择" @confirm="onConfirm" />
    ...
    <mot-toast v-model:visible="showToast" :msg="msg" type="text" />
  </div>
</template>
