...
<template>
  <div class="demo h-100vh!">
    <mot-cell title="基础用法" is-link @click="state.visible1 = true" />
    <mot-short-password
    ...
    />
    <mot-number-keyboard v-model="state.value1" v-model:visible="state.showKeyboard1" />
    ...
    />
    <mot-number-keyboard v-model="state.value2" v-model:visible="state.showKeyboard2" maxlength="4" />
    <mot-cell
      title="忘记密码提示语事件回调"
      is-link
      @click="
    ...
    <mot-short-password
      ...
      @tips="methods.onTips"
    />
    <mot-number-keyboard v-model="state.value3" v-model:visible="state.showKeyboard3" />
    ...
    <mot-cell
      ...
      "
    />
    <mot-toast v-model:visible="state.show" msg="忘记密码" type="text" :cover="state.cover" />
    <mot-short-password
      ...
      @tips="methods.onTips"
    />
    <mot-number-keyboard v-model="state.value4" v-model:visible="state.showKeyboard4" />
  </div>
</template>
