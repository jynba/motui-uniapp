...
<template>
  <div class="demo full">
    ...
    <mot-tabs v-model="state.tab1value" align="left">
      <mot-tab-pane title="Tab 1">
        Tab 1
      </mot-tab-pane>
      <mot-tab-pane title="Tab 2">
    ...
    <mot-tabs v-model="state.tab2value" swipeable>
    ...
    <mot-tabs v-model="state.tab2value" :auto-height="true">
      ...
      <mot-tab-pane title="Tab 2" pane-key="1">
        Tab 2
      </mot-tab-pane>
      <mot-tab-pane title="Tab 3" pane-key="2">
        Tab 3
    ...
    <mot-tabs v-model="state.tab3value">
      <mot-tab-pane v-for="item in state.list3" :key="item" :title="`Tab ${item}`">
        Tab {{ item }}
      </mot-tab-pane>
    </mot-tabs>
    ...
    <mot-tabs v-model="state.tab4value" title-scroll title-gutter="10">
      <mot-tab-pane v-for="item in state.list4" :key="item" :title="`Tab ${item}`">
        Tab {{ item }}
      </mot-tab-pane>
    </mot-tabs>
    <h2 class="title">
    ...
    <mot-tabs v-model="state.tab5value" custom-style="height: 300px;" title-scroll direction="vertical">
      <mot-tab-pane v-for="item in state.list5" :key="item" :pane-key="item" :title="`Tab ${item}`">
        Tab {{ item }}
      </mot-tab-pane>
    </mot-tabs>
    <h2 class="title">
    ...
    <mot-tabs v-model="state.tab6value" custom-style="height: 300px;" type="smile" title-scroll direction="vertical">
      <mot-tab-pane v-for="item in state.list5" :key="item" :pane-key="item" :title="`Tab ${item}`">
        Tab {{ item }}
      </mot-tab-pane>
    </mot-tabs>
    ...
    <mot-tabs v-model="state.tab7value" swipeable>
      ...
      <mot-tab-pane v-for="item in state.list6" :key="item.paneKey" title="" :pane-key="item.paneKey">
        {{ item.title }}
      </mot-tab-pane>
    </mot-tabs>
    <mot-tabs v-model="state.tab11value" direction="vertical">
      <mot-tab-pane title="Tab 1" pane-key="0">
        <mot-tabs v-model="state.tab1value">
          <mot-tab-pane title="Tab 1" pane-key="0.0">
            Tab 1
          </mot-tab-pane>
          <mot-tab-pane title="Tab 2" pane-key="0.1">
            Tab 2
          </mot-tab-pane>
          <mot-tab-pane title="Tab 3" pane-key="0.2">
            Tab 3
          </mot-tab-pane>
        </mot-tabs>
      </mot-tab-pane>
