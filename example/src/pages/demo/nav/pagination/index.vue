...
<template>
  <div class="demo h-100vh!">
    ...
    <mot-pagination v-model="currentPage2" :total-items="125" :show-page-size="3" force-ellipses @change="pageChange" />
    <h2 class="title">
      自定义按钮
    </h2>
    <mot-pagination v-model="currentPage3" :total-items="500" :show-page-size="5" @change="pageChange">
      <template #prevText>
