...
<template>
  <div class="demo countup-demo h-100vh!">
    ...
    <div class="show-demo">
      <mot-countup :init-num="0" :end-num="200" />
      <mot-countup :init-num="150.0" :end-num="0.0" :speed="6.18" :to-fixed="2" />
      <mot-countup :init-num="500.0" :end-num="0.0" :speed="17" :to-fixed="2" />
    </div>
    <h2 class="title">
      自定义滚动图片展示
    </h2>
    ...
    <div class="show-demo">
      ...
      />
      <div class="btnBtn">
        <mot-button type="danger" :disabled="startFlag" @click="startRole">
          中奖
        </mot-button>
        <mot-button type="danger" :disabled="startFlag" @click="startRole2">
          不中奖
        </mot-button>
      </div>
    </div>
