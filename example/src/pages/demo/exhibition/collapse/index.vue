...
<template>
  <div class="demo full">
    ...
    <mot-collapse v-model="active1" @change="change">
    ...
    <mot-collapse v-model="active2" :accordion="true">
      <mot-collapse-item :title="title1" :name="1">
        <template #value>
          文本测试
        </template>
      ...
      <mot-collapse-item :title="title2" :name="2" :value="subTitle">
        中国服务机器人市场已占全球市场超1/4
      </mot-collapse-item>
    ...
    <mot-collapse v-model="active3" :accordion="true">
      <mot-collapse-item :title="title1" :name="1" icon="notice">
        京东数科IPO将引入“绿鞋机制”
      </mot-collapse-item>
      <mot-collapse-item :title="title2" :name="2" value="文本内容" icon="follow">
    ...
    <mot-collapse v-model="active6" :accordion="true">
      <mot-collapse-item :title="title1" :name="1">
        <template #extra>
          固定内容
        </template>
        MotUI是一套拥有轻量级的 Vue 组件库
      </mot-collapse-item>
      <mot-collapse-item :title="title2" :name="2">
