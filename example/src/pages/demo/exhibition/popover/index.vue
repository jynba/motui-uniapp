...
import type { PopoverLocation } from 'motui-uniapp'
  ...
  <div class="demo h-100vh!">
    ...
    <mot-row type="flex">
      <mot-col :span="8">
        ...
        >
          <template #reference>
            <mot-button type="primary" shape="square">
              明朗风格
            </mot-button>
          </template>
        </mot-popover>
      ...
      <mot-col :span="8">
        <mot-popover v-model:visible="darkTheme" theme="dark" :list="iconItemList">
          <template #reference>
            <mot-button type="primary" shape="square">
              暗黑风格
            </mot-button>
    ...
    <mot-row type="flex">
      <mot-col :span="8">
        <mot-popover v-model:visible="showIcon" theme="dark" :list="itemList" custom-class="popover-demo-custom">
          <template #reference>
            <mot-button type="primary" shape="square">
              展示图标
            </mot-button>
    ...
    <mot-popover v-model:visible="Customized" location="right" custom-class="customClass">
      <template #reference>
        <mot-button type="primary" shape="square">
          自定义内容
        </mot-button>
    ...
    <mot-cell title="点击查看更多方向" @click="handlePicker" />

    <mot-popup v-model:visible="showPicker" :destroy-on-close="false" position="bottom" custom-class="popover-demo-custom">
      <mot-picker
