...
export default {
  setup() {
    ...
    const chooseItem = (itemParams: any) => {
      uni.showToast({ title: `itemParams: ${JSON.stringify(itemParams)}` })
...
<template>
  <div class="demo actionsheet h-100vh!">
    ...
    <mot-cell :show-icon="true" :is-link="true" @click="switchActionSheet('isVisible1')">
      <span><label>基础用法</label></span>
      <div v-html="state.val1" />
    </mot-cell>
    <mot-cell :show-icon="true" :is-link="true" @click="switchActionSheet('isVisible2')">
      <span><label>展示取消按钮</label></span>
      <div v-html="state.val2" />
    </mot-cell>
    <mot-cell :is-link="true" @click="switchActionSheet('isVisible3')">
    ...
    <mot-cell :is-link="true" @click="switchActionSheet('isVisible4')">
    ...
    <mot-cell :is-link="true" @click="switchActionSheet('isVisible5')">
