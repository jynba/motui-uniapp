...
```html
<template>
  <mot-table :columns="columns" :data="data"></mot-table>
</template>
<script lang="ts">
...
```html
<template>
  <mot-table :columns="columns" :data="data" :bordered="bordered"></mot-table>
</template>
<script lang="ts">
...
```html
<template>
  <mot-table :columns="columns" :data="data" :summary="summary"></mot-table>
</template>
<script lang="ts">
  import { reactive, toRefs } from 'vue';
  export default {
...
```html
<template>
  <mot-table :columns="columns3" :data="data2" :striped="striped"></mot-table>
</template>
<script lang="ts">
  import { reactive, toRefs } from 'vue';
  export default {
...
<script lang="ts">
  import { reactive, toRefs, h } from 'vue';
  import NutButton from 'motui-uniapp/components/button/button.vue'、
  import NutIcon from 'motui-uniapp/components/icon/icon.vue'
...
```html
<template>
  <mot-table :columns="columns" :data="data" @sorter="handleSorter"></mot-table>
</template>
<script lang="ts">
  import { reactive, toRefs } from 'vue';
  export default {
...
| 名称                         | 默认值           |
| ---------------------------- | ---------------- |
| --mot-table-border-color     | #ececec          |
| --mot-table-cols-padding     | 10px             |
| --mot-table-tr-even-bg-color | #f3f3f3          |
| --mot-table-tr-odd-bg-color  | var(--mot-white) |
