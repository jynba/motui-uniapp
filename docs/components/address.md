...
```html
<template>
  <mot-cell title="选择地址" :desc="text" is-link @click="showAddress"></mot-cell>
  <mot-address
...
```html
<template>
  <mot-cell title="选择地址" :desc="text" type="custom2" is-link @click="showAddress"></mot-cell>
  <mot-address
    v-model="value"
    v-model:visible="showPopup"
    type="custom2"
...
```html
<template>
  <mot-cell title="选择地址" :desc="text" is-link @click="showAddressExist"></mot-cell>
  <mot-address
...
```html
<template>
  <mot-cell title="选择地址" :desc="text" is-link @click="showCustomImg"></mot-cell>
  <mot-address
  ...
  >
    <template #unselectedIcon>
      <mot-icon name="heart1" style="margin-right:8px">
    </template>
    <template #icon>
      <mot-icon name="heart-fill" style="margin-right:8px" color="#f00"/>
    </template>
    <template #bottom>
...
```html
<template>
  <mot-cell title="选择地址" :desc="text" is-link @click="showAddressOther"></mot-cell>
  <mot-address
...
| 名称                                             | 默认值                                                                        |
| ------------------------------------------------ | ----------------------------------------------------------------------------- |
| --mot-address-region-tab-line                    | linear-gradient(90deg, var(--mot-primary-color) 0%, rgba(#fa2c19, 0.15) 100%) |
| --mot-address-icon-color                         | var(--mot-primary-color)                                                      |
| --mot-address-header-title-font-size             | 18px                                                                          |
| --mot-address-header-title-color                 | #262626                                                                       |
| --mot-address-region-tab-font-size               | 13px                                                                          |
| --mot-address-region-tab-color                   | #1d1e1e                                                                       |
| --mot-address-region-tab-active-item-font-weight | bold                                                                          |
| --mot-address-region-tab-line-border-radius      | 0                                                                             |
| --mot-address-region-tab-line-opacity            | 1                                                                             |
| --mot-address-region-item-color                  | #333                                                                          |
| --mot-address-region-item-font-size              | var(--mot-font-size-1)                                                        |
| --mot-address-item-margin-right                  | 9px                                                                           |
