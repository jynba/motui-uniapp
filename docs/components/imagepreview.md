...
```html
<template>
    <mot-image-preview :show="showPreview" :images="imgData" @close="hideFn"/>
    <mot-cell isLink title="展示图片预览" :showIcon="true" @click="showFn"></mot-cell>
</template>
...
```html
<template>
    <mot-image-preview :show="showPreview" :images="imgData" :init-no="3" @close="hideFn"/>
    <mot-cell isLink title="设置初始页码" :showIcon="true" @click="showFn"></mot-cell>
</template>
<script lang="ts">
  import { reactive, toRefs } from 'vue';
  export default {
...
<template>
    <mot-image-preview
        ...
        @close="hideFn"
    />
    <mot-cell isLink title="设置轮播指示器及颜色" :showIcon="true" @click="showFn"></mot-cell>
</template>
<script lang="ts">
  import { reactive, toRefs } from 'vue';
  export default {
...
```html
<template>
  <mot-image-preview :show="showPreview" :images="imgData" @close="hideFn" @long-press="longPress" />
  <mot-cell isLink title="长按图片事件，保存到相册" :showIcon="true" @click="showFn"></mot-cell>
</template>
