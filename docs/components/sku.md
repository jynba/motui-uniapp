...
| 名称                                   | 默认值                                                                                                |
| -------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| --mot-sku-item-border                  | 1px solid var(--mot-primary-color)                                                                    |
| --mot-sku-item-disable-line            | line-through                                                                                          |
| --mot-sku-opetate-bg-default           | linear-gradient(90deg, var(--mot-primary-color), var(--mot-primary-color-end) 100%)                   |
| --mot-sku-item-active-bg               | var(--mot-primary-color)                                                                              |
| --mot-sku-opetate-bg-buy               | linear-gradient(135deg,rgba(255, 186, 13, 1) 0%,rgba(255, 195, 13, 1) 69%,rgba(255, 207, 13, 1) 100%) |
| --mot-sku-spec-height                  | 30px                                                                                                  |
| --mot-sku-spec-line-height             | var(--mot-sku-spec-height)                                                                            |
| --mot-sku-spec-font-size               | 11px                                                                                                  |
| --mot-sku-spec-background              | rgba(242, 242, 242, 1)                                                                                |
| --mot-sku-spec-color                   | var(--mot-black)                                                                                      |
| --mot-sku-spec-margin-right            | 12px                                                                                                  |
| --mot-sku-spec-padding                 | 0 18px                                                                                                |
| --mot-sku-spec-title-font-weight       | bold                                                                                                  |
| --mot-sku-spec-title-font-size         | 13px                                                                                                  |
| --mot-sku-spec-title-color             | var(--mot-black)                                                                                      |
| --mot-sku-spec-title-margin-bottom     | 18px                                                                                                  |
| --mot-sku-operate-btn-height           | 54px                                                                                                  |
| --mot-sku-operate-btn-border-top       | 0                                                                                                     |
| --mot-sku-operate-btn-item-height      | 40px                                                                                                  |
| --mot-sku-operate-btn-item-line-height | var(--mot-sku-operate-btn-item-height)                                                                |
| --mot-sku-operate-btn-item-font-size   | 15px                                                                                                  |
| --mot-sku-operate-btn-item-font-weight | normal                                                                                                |
| --mot-sku-product-img-width            | 100px                                                                                                 |
| --mot-sku-product-img-height           | var(--mot-sku-product-img-width)                                                                      |
| --mot-sku-product-img-border-radius    | 0                                                                                                     |
