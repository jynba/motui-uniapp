...
| 名称                             | 默认值                 |
| -------------------------------- | ---------------------- |
| --mot-card-font-size-0           | var(--mot-font-size-0) |
| --mot-card-font-size-1           | var(--mot-font-size-1) |
| --mot-card-font-size-2           | var(--mot-font-size-2) |
| --mot-card-font-size-3           | var(--mot-font-size-3) |
| --mot-card-left-border-radius    | 0                      |
| --mot-card-left-background-color | inherit                |
